...
<body>
	<div class="container">
		<div class="row">
			<div class="col-md-3">
			<h3 class="right">Welcome <?=$userinfo['first_name']?></h3>
			</div>
		...
		<div class="row">
			<div class="col-md-7" id="last_reviews">
				...
				<div class="review">
					...
					<p><a href="#username">Jerry</a> says: Very inspiring. Gives a lot of wisdom on life.</p>
				...
				<div class="review">
					...
					<p>Rating: 5 stars</p>
					<p><a href="#username">Jessica</a> says: Sort of inspiring. Gives a bit of wisdom on life.</p>
				...
				<div class="review">
					...
					<p>Rating: 1 stars</p>
					<p><a href="#username">James</a> says: Uninspiring. Gives zero  wisdom on life.</p>
